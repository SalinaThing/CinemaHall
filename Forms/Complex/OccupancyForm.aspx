<%@ Page Title="Movie Theater Occupancy" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
  ...
  <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="text-muted">Shows the top 3 theaters with maximum seat occupancy (%) for a selected movie. Only
      <strong>Paid</strong> tickets are counted as occupancy.</p>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="row g-3 align-items-end">
          ...
          <div class="col-md-2">
            <asp:Button ID="btnSearch" runat="server" Text="Get Top 3" CssClass="btn btn-danger w-100"
    ...
    <asp:Panel ID="pnlMovie" runat="server" Visible="false" CssClass="card mb-4">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-3"><strong>Title:</strong>
            <asp:Label ID="lblMTitle" runat="server" />
          </div>
          <div class="col-md-2"><strong>Genre:</strong>
            <asp:Label ID="lblMGenre" runat="server" />
          </div>
          <div class="col-md-2"><strong>Language:</strong>
            <asp:Label ID="lblMLang" runat="server" />
          </div>
          <div class="col-md-2"><strong>Duration:</strong>
            <asp:Label ID="lblMDur" runat="server" /> min
          </div>
          <div class="col-md-3"><strong>Release Date:</strong>
            <asp:Label ID="lblMRel" runat="server" />
          </div>
        </div>
      </div>
    </asp:Panel>
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <asp:GridView ID="gvOccupancy" runat="server" CssClass="table table-hover mb-0" AutoGenerateColumns="false"
            EmptyDataText="No paid ticket data found.">
            <Columns>
