        ...
        <div class="col-md-8">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-header border-0 bg-transparent py-4 d-flex justify-content-between align-items-center">
                    ...
                    <a href='<%= ResolveUrl("~/Forms/Basic/TicketForm.aspx") %>' class="btn btn-sm btn-light px-3 text-danger fw-bold">View All</a>
                </div>
                <div class="card-body p-0">
                    <asp:GridView ID="gvRecent" runat="server" CssClass="table table-hover mb-0"
                        ...
                        <Columns>
                            <asp:BoundField DataField="TicketId" HeaderText="ID" ItemStyle-CssClass="ps-4" HeaderStyle-CssClass="ps-4" />
                            ...
                            <asp:TemplateField HeaderText="Status" ItemStyle-CssClass="pe-4" HeaderStyle-CssClass="pe-4">
                                <ItemTemplate>
                                    <span class='badge rounded-pill px-3 <%# Eval("TicketStatus").ToString() == "Paid" ? "bg-success-subtle text-success" : "bg-warning-subtle text-warning" %>'>
                                        <%# Eval("TicketStatus") %>
                                    </span>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <div class="card h-100 border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush gap-2">
                        <a href='<%= ResolveUrl("~/Forms/Basic/MovieForm.aspx") %>' class="list-group-item list-group-item-action border-0 rounded-3 bg-light-subtle d-flex align-items-center">
                           <div class="bg-danger-subtle p-2 rounded-2 me-3"><i class="bi bi-plus-circle text-danger"></i></div>
                           Add New Movie
                        </a>
                        <a href='<%= ResolveUrl("~/Forms/Basic/ShowForm.aspx") %>' class="list-group-item list-group-item-action border-0 rounded-3 bg-light-subtle d-flex align-items-center">
                           <div class="bg-primary-subtle p-2 rounded-2 me-3"><i class="bi bi-calendar-plus text-primary"></i></div>
                           Schedule Show
                        </a>
                        <a href='<%= ResolveUrl("~/Forms/Complex/OccupancyForm.aspx") %>' class="list-group-item list-group-item-action border-0 rounded-3 bg-light-subtle d-flex align-items-center">
                           <div class="bg-success-subtle p-2 rounded-2 me-3"><i class="bi bi-download text-success"></i></div>
                           Occupancy Report
                        </a>
                        <a href='<%= ResolveUrl("~/Forms/Complex/UserTicketForm.aspx") %>' class="list-group-item list-group-item-action border-0 rounded-3 bg-light-subtle d-flex align-items-center">
                           <div class="bg-warning-subtle p-2 rounded-2 me-3"><i class="bi bi-search text-warning"></i></div>
                           User History
                        </a>
                    </div>
                </div>
